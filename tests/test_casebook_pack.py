"""Regression checks for the onyx-trade-backtest-pipe casebook."""
...
from casebook.harness import assert_expected, onyx_trade_backtest_pipe_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(onyx_trade_backtest_pipe_summary(), assert_expected())
